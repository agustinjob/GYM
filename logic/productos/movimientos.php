...
<head>
    ...
    function movimientosPorFecha(){
     
       tipo= $("#tipoFecha").val();

       if(tipo === "0"){
           alert("Por favor selecciona una de la opciones para mostrar los movimientos");
           return false;
       }

       parametros={
           "tipo":tipo,
           "opcion":"movimientos_periodo_fecha"
       };
       ...
       $.ajax({
           ...
           success:function(response){
            ...
            $("#totalVendido").html("Movimientos por periodo, total de movimientos: " + respues[1]);

           }
       });
    }

       function movimientosPorLapsosDeFecha(){
        ...
        parametros={
            ...
            "fechaFin":fechaFin,
            "opcion":"movimientos_por_lapsos_de_tiempo"
        };
        $.ajax({
            data:parametros,
            url:"../logicaNegocio.php",
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <center>
                                        <h6 id="totalVendido" class="m-0 font-weight-bold text-primary">Movimientos por periodo, total surtido: 0</h6>
                                    </center> 
                                 </div>
                                 <div class="card-body">
                                 <form class="user">
                                 ...
                                 <div class="col-sm-6">
                                    ...
                                    <a href="#" onclick="movimientosPorFecha();" class="btn btn-success btn-icon-split">
                                    ...
                                    <a href="#" onclick="movimientosPorLapsosDeFecha();" class="btn btn-warning btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-check"></i>
                                        </span>
